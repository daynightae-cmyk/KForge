...
Implemented on top of `f57d0ddce3f7fbec02dfa36299e77c5a1428fc1c`, verified locally as recorded below. CI attestation: GitHub Actions `KForge Verification Gate` Run **34412720862** is green on the exact final SHA `7e36c34a1259f71a0f2c0af9d9cc0a1791afca21` — aggregate verification gate PASS and Windows NSIS package gate PASS, with installer/verification artifacts uploaded.
