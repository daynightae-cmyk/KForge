...
function CapabilitySurface({ activeNav, project, projects, scan, tasks, results, platform, settings, searchSelection, onSettingsChange, onPlatformModeChange, onOpenProject, onRun, onTaskControl, onTrust, onNavigate, onProjectCollectionUpdate }: { activeNav: string; project: ProjectSummary; projects: ProjectSummary[]; scan?: ProjectScan; tasks: TaskItem[]; results?: Partial<Record<WorkspaceAction, CommandResult>>; platform?: LocalPlatformStatus; settings: KForgePlatformSettings | null; searchSelection?: GlobalSearchResult; onSettingsChange: (settings: KForgePlatformSettings) => void; onPlatformModeChange: (mode: LocalPlatformStatus["mode"]) => void; onOpenProject: () => void; onRun: (action: WorkspaceAction) => void; onTaskControl: (task: TaskItem, control: "cancel" | "retry" | "resume" | "rollback") => void; onTrust: () => void; onNavigate: (label: string) => void; onProjectCollectionUpdate: (project: ProjectSummary, patch: Partial<Pick<ProjectSummary, "favorite" | "pinned" | "archived" | "tags">>) => void }) {
