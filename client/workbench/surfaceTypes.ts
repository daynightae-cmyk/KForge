...
export const SURFACE_AUDIT_MATRIX: Record<KForgeActivity, Record<string, ProductSurfaceClass>> = {
  ...
  quality: { sonar: "SPECIALIZED", problems: "SPECIALIZED", solutions: "SPECIALIZED", security: "INTENTIONALLY_SHARED", performance: "INTENTIONALLY_SHARED", "technical-debt": "INTENTIONALLY_SHARED", documentation: "SPECIALIZED", snapshots: "INTENTIONALLY_SHARED" },
