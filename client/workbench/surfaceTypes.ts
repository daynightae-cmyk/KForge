...
export const SURFACE_AUDIT_MATRIX: Record<KForgeActivity, Record<string, ProductSurfaceClass>> = {
  ...
  "developer-tools": { terminal: "SPECIALIZED", tests: "SPECIALIZED", build: "INTENTIONALLY_SHARED", runtime: "INTENTIONALLY_SHARED", lint: "INTENTIONALLY_SHARED", logs: "SPECIALIZED", diagnostics: "SPECIALIZED", preview: "INTENTIONALLY_SHARED" },
