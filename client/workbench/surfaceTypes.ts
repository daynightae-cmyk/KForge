...
export const SURFACE_AUDIT_MATRIX: Record<KForgeActivity, Record<string, ProductSurfaceClass>> = {
  ...
  quality: { sonar: "SPECIALIZED", problems: "SPECIALIZED", solutions: "SPECIALIZED", security: "SPECIALIZED", performance: "SPECIALIZED", "technical-debt": "INTENTIONALLY_SHARED", documentation: "SPECIALIZED", snapshots: "SPECIALIZED" },
