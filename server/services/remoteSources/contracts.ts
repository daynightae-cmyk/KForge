...
export const REMOTE_SOURCE_IDS = ["mcp-official-registry", "open-vsx", "osv", "hugging-face-hub", "github-releases-kforge", "remote-doc-openapi", "npm-registry", "pypi", "nuget-v3", "winget-community"] as const;
