...
function preview(): PreviewStatus {
  return { projectId: "project", state: "idle", logs: [], healthHistory: [], startupTimeline: [], routes: [], history: [], runtime: { execution: "LOCAL", network: "NOT_REQUIRED", source: "detected-project-script", projectSourceSent: false }, telemetry: { console: "process-stdout-stderr", network: "loopback-health-probe-only", browserConsoleCaptured: false }, embedding: { state: "UNKNOWN" } };
}
